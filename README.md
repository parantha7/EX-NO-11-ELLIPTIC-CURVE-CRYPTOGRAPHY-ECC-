...
secret
 sharedSecretB = scalarMultiplication(publicA, privateB, a, p); // Bob's shared
secret
 printf("Shared secret computed A: (%lld, %lld)\n", sharedSecretA.x,
sharedSecretA.y);
 printf("Shared secret computed by B: (%lld, %lld)\n", sharedSecretB.x,
sharedSecretB.y);
 if (sharedSecretA.x == sharedSecretB.x && sharedSecretA.y ==
sharedSecretB.y) {
...
## Output:
<img width="746" height="442" alt="image" src="https://github.com/user-attachments/assets/aedcfa04-26cd-449f-b70a-354b595130ed" />
